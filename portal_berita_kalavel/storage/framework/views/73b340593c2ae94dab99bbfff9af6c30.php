<nav id="Navbar" class="max-w-[1130px] mx-auto flex justify-between items-center mt-[30px]">
    <div class="logo-container flex gap-[30px] items-center">
        <a href="<?php echo e(route('front.index')); ?>" class="flex shrink-0">
            <img src="<?php echo e(asset('assets/images/logos/logo.svg')); ?>" alt="logo" class="h-[120px] w-auto"/>
        </a>
    ...
    <div class="flex items-center gap-3">
        <a href="<?php echo e(route('front.premium')); ?>"
        ...
        <a href="<?php echo e(route('front.iklan')); ?>"
            ...
            <div class="flex w-6 h-6 shrink-0">
                <img src="<?php echo e(asset('assets/images/icons/favorite-chart.svg')); ?>" alt="icon" />
            </div>
            <span>Pos Iklan</span>
        </a>
    </div>
</nav>
<?php /**PATH D:\laragon\www\portal_berita_kalavel\resources\views/components/navbar.blade.php ENDPATH**/ ?>